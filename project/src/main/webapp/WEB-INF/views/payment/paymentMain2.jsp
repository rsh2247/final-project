	...
	<div class="contents">
        ...
        <div class="payment_wrap">
            ...
            <table class="board_list"  id="lec_board_list">
                        	...
                        	<tr>
                                <td class="title">${orderlist[0].lecture_name}</td>
            ...
            <p class="total_price" style="color:#cc0000;">
                <span style="font-size:8pt; position:relative; right:170px;">* 이벤트 상품은 포인트 사용이 불가합니다.</span>
                <span>총 주문금액 : <em>${orderlist[0].lecture_tuition}원</em></span></p>
            <!-- // 주문내역 끝 -->
            <!-- 할인/결제금액 --> 
                    <div class="sale_pay"
                 style="display:block">
                ...
                <dl>
                    ...
                    <dd>
                        <ul>
                            <li class="total_order" id="total_order_total"><em>${orderlist[0].lecture_tuition}</em>원
                            </li>
                ...
                <div class="total_order">
                    ...
                    <p class="point_coupon"><span>현재 보유포인트 : <em>{}P</em></span>
                    ...
                    <table class="board_list" id="lec_board_list2">
                        ...
                        <tr>
                                        ...
                                        <td colspan="2" id="pt19915433">
                                            <input type="text" class="dispt" name="dispt" id="dispt19915433" 
                                            onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false; " 
                                            style="ime-mode:disabled;" onkeyup="point_check(19915433);" />
                                            <strong> P </strong><a href="javascript:point_apply(19915433);">적용</a>
                                        </td>
                        </tr>
                    </table>

                    <ul class="text" style="padding:17px 0 24px 35px;">
                        <li style="list-style-type: circle; text-align: left; color:#939292; line-height:16px; font-size:11px;">
                            	포인트와 쿠폰 할인은 한 개의 강의에 동시에 사용하실 수 없습니다.
                        </li>
                        <li style="list-style-type: circle; text-align: left; color:#939292; line-height:16px; font-size:11px;">
                            	구매시 사용한 쿠폰과 포인트는 결제 취소 후 재사용이 불가능합니다.
                        </li>
                    </ul>
                </div>
                <div class="total_price">
                    ...
                    <dl class="total_sale">
                        <dt>총 할인내역</dt>
                        <dd>포인트<span id="ptsale">0 P</span></dd>
                        <dd>교재 마일리지<span id="book_ptsale">0 P</span></dd>
                        <dd>쿠폰/할인혜택<span id="cpsale">0 원</span></dd>
                    </dl>
    
                    <dl class="benefit">
                        <dt>구매 혜택</dt>
                        <dd>예상 적립포인트</dd>
                        <dd class="point"><span id="preusept">0 P</span></dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="order_info">
                ...
                <!-- 회원가입시 개인정보 위탁동의를 체크하지 않았을 경우 노출 (#개인정보위탁동의) -->
                            <h3 class="title">최소 시스템 사양 및 필수 소프트웨어 [<a href="#;" class="check_btn">자세히 보기▼</a>]</h3>
                <div class="type_pay" id="detail_info" style="display:none;">
                    <table class="board_list type_pay">
                        ...
                        <tr>
                            ...
                            <td>
                                GeForce MX440 AGP8 이상<br>
                                (Intel:915G 칩셋, AMD:Xpress200시리즈 이상)
                            </td>
                        </tr>
                        <tr>
                            <td class="first-child">기술적보호조치에 관한 사항</td>
                            <td>
                                컨텐츠의 불법사용 및 유출방지-Windows Media DRM,Aqua Auth<br>
                                컨텐츠의 녹화차단-Aqua Director 컨텐츠의 다운로드 DRM-NETSYNC DRM</td>
                        </tr>
                        <tr>
                    ...
                    <p style="color:#cc0000;"><br />[미성년자 계약의 취소]<br />
                        미성년자인 회원이 법정대리인의 동의없이 이용계약을 체결한 경우에 회원 또는 그의 법정대리인은 계약을 취소할 수 있다. </p>
                    <div class="type_pay">
                        <table class="board_list type_pay">
                            <colgroup>
                                <col width="12%">
                            ...
                            <tr>
                                <td rowspan="2" class="first-child" style="border-left:1px solid #cdcdcd">부분환불</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="left">
                                    * 반품/교환가능 기간: 변심반품의 경우 결제일로부터 10일 이내 또는 수령일로부터 7일 이내, 상품의 결함 및 계약내용과 다를 경우 그 재화 등을 공급받은 날부터 3개월 이내에 가능하며, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 가능합니다. 교재배송 출발 이후 환불 요청을 하실 경우, 배송/반송에 소요된 요금을 제외하고 환불 진행이 가능합니다. (이 때, 30일 이내란 해당 재화등을 공급받은 날부터 3개월 이내에만 적용됩니다.)
                                </td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <ul class="notice">
                        ...
                        <li>- 환불 절차 및 자세한 사항은 <a href="//egosi.hackers.com/site/?c=customer&idx=2&cate_big=결제문의&cate_small=4" target="_blank">[여기]</a>를 참고하시기 바랍니다</li>
                    </ul>
                    <p>
                        <input type="checkbox" id="check_refund">
                        <label for="check_refund" class="color_red">환불 규정을 충분히 이해하였고, 이에 동의합니다. (필수)</label>
                    </p>
                    ...
                    <div class="guideWrap">
                        <div class="guideWay">
                            <p>
                                본 상품의 요금 결제 처리를 위하여 결제 관련 개인정보의 위탁 처리가 필요합니다. 개인정보 위탁에 대하여 거부할 권리가 있으며, 거부 시 상품 구매에 제한을 받을 수 있습니다.
                            </p>
                            <ul class="guideEtc">
                                <li>
                                    요금결제 관련<br/>
                                    - 위탁대상 : 카카오페이<br/>
                                    - 위탁내용 : 상품 또는 서비스의 구매 및 요금 결제<br/>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <p>
                        ...
                        <label for="check_payment" class="color_red">결제 관련 개인정보 처리업무 위탁에 대하여 동의합니다. (필수)</label>
                    </p>
                        ...
                        <p>
                            <input type="checkbox" id="check_useguide">
                            <label for="check_useguide" class="color_red">상기 이용안내 및 유의사항을 확인 및 이해하였으며, 이에 동의합니다. (필수)</label>
                        </p>
                    <h3 class="title ">이용약관</h3>
                    <p class="rep">
                        - 선생님 강의 변동사항 발생 시 미리 공지해 드릴 예정이며, 그 경우 다른 선생님 강의로 변경 가능합니다.<br />
                        - 제공되는 동영상 강의는 추후 변경될 수 있습니다<br />
                        - 이용약관을 살펴보시려면 [<a href="">여기</a>]를 클릭해 주세요.<br/>
                        - 결제취소 및 상품 관련 기타 문의, 소비자피해보상의 처리, 재화 등에 대한 불만 처리 및 소비자와 사업자 사이의 분쟁 처리에 관한 사항은 고객센터(00-0000-0000)를 이용해 주세요.<br /> 
                        <a href="" target="_blank"><b>공지 확인하기 ></b></a><br/>               
                    </p>                
                <p>
                    <input type="checkbox" id="check_contents" value="agree">
                    <label for="check_contents">상기 내용을 확인 및 이해하였으며, 이에 동의합니다.</label>
                </p>
                ...
                <p class="btn" id="paybtn">
                    ...
                    <a href="javascript:trade_select();">결제하기</a>
