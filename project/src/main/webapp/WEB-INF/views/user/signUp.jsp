	...
	<form id="action" action="user.signUp" method="post">
		<div id="tablebox">
			<table id="inputform">
				...
				<tr style="border: 0px;">
					<td class="leftbox"><div class="item">ID</div></td>
				...
				<tr>
					<td class="leftbox"><div class="item">Password</div></td>
					<td><input class="inputbox" name="pw" type="password" id="pwbox"></td>
				</tr>
				<tr>
					<td class="leftbox"><div class="item">NickName</div></td>
					<td><input class="inputbox" name="nickName" type="text"></td>
				</tr>
				<tr>
					<td class="leftbox"><div class="item">Email</div></td>
