...
<head>
   ...
   <!-- .css -->
   <link href="<c:url value="/resources/calendar/vendor/css/fullcalendar.min.css" />" rel="stylesheet">
   <link href="<c:url value="/resources/calendar/vendor/css/bootstrap.min.css" />" rel="stylesheet">
   <link href="<c:url value="/resources/calendar/vendor/css/select2.min.css" />" rel="stylesheet">
   <link href="<c:url value="/resources/calendar/vendor/css/bootstrap-datetimepicker.min.css" />" rel="stylesheet">
   <link href="<c:url value="https://fonts.googleapis.com/css?family=Open+Sans:400,500,600" />" rel="stylesheet">
   <link href="<c:url value="https://fonts.googleapis.com/icon?family=Material+Icons" />" rel="stylesheet">
   <link href="<c:url value="/resources/calendar/css/main.css" />" rel="stylesheet">    
...
<body>
   ...
   <!-- .js -->
	...
	<script src="<c:url value="/resources/calendar/vendor/js/moment.min.js" />"></script>
	<script src="<c:url value="/resources/calendar/vendor/js/fullcalendar.min.js" />"></script>
	<script src="<c:url value="/resources/calendar/vendor/js/ko.js" />"></script>
	<script src="<c:url value="/resources/calendar/vendor/js/select2.min.js" />"></script>
	<script src="<c:url value="/resources/calendar/vendor/js/bootstrap-datetimepicker.min.js" />"></script>
